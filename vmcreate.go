...
var result string
var vpcname, group, imageid, instancetype, cmd1, keyname = "vpc-9df038e0", "any-grp", "ami-08c40ec9ead489470", "t2.micro", "sg-0a94428cbd8cc8bfa", "awskey1"
func createAWSVM() {
	aws := "aws"
	ec2 := "ec2"
	...
	fmt.Println("Op is %v\n",string(output1))
      ...
      log.Print("command: >> %v\n",cmd4)
      cmd10 := exec.Command(aws,ec2,authorize,groupid,s,protocol,tcp,port,port3,cidr,cidr1)
      log.Print("command: >> %v\n",cmd10)
     cmd4.Stderr = &stderr
...
/*func deleteAWSVM(result string) {
	...
	fmt.Println("Deleted vm",output7)
